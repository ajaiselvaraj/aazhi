...
const SmartCityControls: React.FC<Props> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-slate-950/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] overflow-hidden text-left relative z-10"
      style={{
