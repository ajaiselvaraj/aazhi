...
const GasQuickPay: React.FC<Props> = ({ onBack, language }) => {
    ...
    useEffect(() => {
        const savedSession = sessionStorage.getItem('aazhi_last_receipt_gas');
        if (savedSession) {
            try {
                ...
                sessionStorage.removeItem('aazhi_last_receipt_gas');
                setStep('INPUT');
            }
        } else {
            setConsumerNo('');
    ...
    const handlePaymentSuccess = (paymentId: string) => {
        ...
        sessionStorage.setItem('aazhi_last_receipt_gas', JSON.stringify({
            consumerNo,
            billData: billData,
