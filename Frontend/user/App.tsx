        ...
        <div className="w-full max-w-[1600px] my-auto py-6 flex flex-col items-center">
          ...
          >
            {LANGUAGES_CONFIG.map((item) => (
              ...
              >
                <span className={`${isVertical ? 'text-3xl' : 'text-2xl sm:text-3xl'
                ...
                <span className={`${isVertical ? 'text-[11px]' : 'text-xs'
