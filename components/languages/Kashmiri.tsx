...
const KashmiriPage: React.FC<Props> = ({ onBack, onContinue }) => {
    return (
            ...
            <div className="w-full max-w-4xl bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white/50 p-10 relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-start gap-8 flex-col md:flex-row">
                    <div className="flex-1">
                        ...
                        <h1 className="text-5xl font-black text-slate-800 mb-2 tracking-tight">Kashmiri <span className="text-blue-600 font-normal ml-2" style={{ fontFamily: 'Arial, sans-serif' }} dir="rtl">(کٲشُر)</span></h1>
                        <p className="text-slate-600 text-lg leading-relaxed mb-8">
                            Kashmiri is an Indo-Aryan language spoken primarily in the Kashmir Valley of Jammu and Kashmir. It uses the Perso-Arabic script for official purposes and boasts a rich literary tradition.
                        </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                                ...
                                <p className="text-sm text-slate-500">Kashmir Valley</p>
                            </div>
                            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                                <Zap className="text-amber-500 mb-3" size={24} />
                                <h3 className="font-bold text-slate-800">Script</h3>
                                <p className="text-sm text-slate-500">Perso-Arabic (Nastaliq)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-[400px] bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden flex-shrink-0">
                        ...
                        <div className="p-6 space-y-4" dir="rtl" style={{ fontFamily: 'Arial, sans-serif' }}>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3" dir="ltr">
                                ...
                                <span className="text-slate-800 font-bold text-lg" dir="rtl">خۄش آمدید</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3" dir="ltr">
                                <span className="text-slate-400 text-sm font-sans">Continue</span>
                                <span className="text-slate-800 font-bold text-lg" dir="rtl">جأری تھاوِو</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3" dir="ltr">
                                <span className="text-slate-400 text-sm font-sans">Login</span>
                                <span className="text-slate-800 font-bold text-lg" dir="rtl">لاگ اِن</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3" dir="ltr">
                                <span className="text-slate-400 text-sm font-sans">Help</span>
                                <span className="text-slate-800 font-bold text-lg" dir="rtl">مَدَتھ</span>
                            </div>
                        </div>
