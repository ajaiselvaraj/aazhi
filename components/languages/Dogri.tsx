...
const DogriPage: React.FC<Props> = ({ onBack, onContinue }) => {
    return (
            ...
            <div className="w-full max-w-4xl bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white/50 p-10 relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-start gap-8 flex-col md:flex-row">
                    <div className="flex-1">
                        ...
                        <h1 className="text-5xl font-black text-slate-800 mb-2 tracking-tight">Dogri <span className="text-blue-600 font-normal ml-2" style={{ fontFamily: '"Noto Sans Devanagari", sans-serif' }}>(डोगरी)</span></h1>
                        <p className="text-slate-600 text-lg leading-relaxed mb-8">
                            Dogri is an Indo-Aryan language primarily spoken in the Jammu region of Jammu and Kashmir, India. It is one of the 22 scheduled languages of India and uses the Devanagari script.
                        </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                                ...
                                <p className="text-sm text-slate-500">Jammu and Kashmir</p>
                            </div>
                            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                    ...
                    <div className="w-full md:w-[400px] bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden flex-shrink-0">
                        ...
                        <div className="p-6 space-y-4" style={{ fontFamily: '"Noto Sans Devanagari", sans-serif' }}>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                                ...
                                <span className="text-slate-800 font-bold text-lg">स्वागत ऐ</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                                <span className="text-slate-400 text-sm font-sans">Continue</span>
                                <span className="text-slate-800 font-bold text-lg">अग्गें वधो</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                                <span className="text-slate-400 text-sm font-sans">Login</span>
                                <span className="text-slate-800 font-bold text-lg">लाग-इन</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
