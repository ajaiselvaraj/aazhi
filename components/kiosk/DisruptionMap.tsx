...
const DisruptionMap: React.FC<Props> = ({ alerts }) => {
    return (
        <div className="bg-white rounded-[2.5rem] p-6 shadow-xl border border-slate-100 h-full relative overflow-hidden">
            <div className="flex justify-between items-start mb-4 relative z-10">
                <div>
                    <h3 className="text-xl font-black text-slate-800">Live Disruption Map</h3>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest hidden sm:block">IoT Sensor Network • Realtime</p>
                </div>
            ...
            <div className="flex items-center gap-6 h-64">
                ...
                <div className="w-1/3 flex flex-col gap-3">
                    <div className="flex items-center gap-2 text-[10px] font-bold text-slate-500">
                        <span className="w-3 h-3 bg-red-200 border border-red-500 rounded-full"></span> Power Outage
                    </div>
                    <div className="flex items-center gap-2 text-[10px] font-bold text-slate-500">
                        <span className="w-3 h-3 bg-blue-200 border border-blue-500 rounded-full"></span> Water Cut
                    </div>
                    <div className="flex items-center gap-2 text-[10px] font-bold text-slate-500">
                        <span className="w-3 h-3 bg-slate-200 border border-slate-400 rounded-full"></span> Normal
                    </div>

                    <div className="mt-auto bg-slate-900 text-white p-3 rounded-xl text-center">
                        <p className="text-[10px] font-black uppercase tracking-widest opacity-50">Est. Restore</p>
