    ...
    return (
        <div className="flex flex-col items-center justify-center py-10 animate-in bounce-in">
            <div className="bg-white p-12 rounded-[4rem] shadow-2xl border border-slate-100 max-w-lg w-full text-center relative overflow-hidden">
                ...
                <h2 className="text-4xl font-black text-slate-900 mb-2 uppercase tracking-tighter">{t.reqFiled || "Request Filed!"}</h2>
                <p className="text-slate-500 font-bold mb-10">{t.smsSent || "A confirmation SMS has been sent to +91"} {mobile}</p>
                ...
                <div className="bg-slate-900 text-white p-8 rounded-[3rem] mb-10 space-y-4">
                    ...
                    <p className="text-[10px] font-black opacity-50 uppercase tracking-widest">{t.scanQr || "Scan QR to continue on Mobile"}</p>
                </div>
