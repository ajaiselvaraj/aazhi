...
const PROPERTY_SERVICES = [
    { id: 'approval', label: 'Building Plan Approval', icon: Home },
    { id: 'track', label: 'Track Permit Status', icon: MapPin },
    { id: 'renovate', label: 'Renovation Permission', icon: Pickaxe },
    { id: 'tax_cert', label: 'Property Tax Assessment', icon: Smartphone },
    { id: 'mutation', label: 'Ownership Mutation', icon: HardHat },
    { id: 'encroach', label: 'Report Encroachment', icon: MapPin }
];
    ...
    return (
        <div className={`flex flex-col h-full bg-slate-50 w-full p-8 font-sans ${isPrivacyOn ? 'privacy-sensitive' : ''}`}>
            <div className="flex justify-between items-center mb-12">
                ...
                />
                <h2 className="text-4xl font-black text-slate-800 tracking-tight">Building & Property</h2>
            </div>
            ...
            <div className="flex-1 max-w-6xl mx-auto w-full">
                            ...
                            {PROPERTY_SERVICES.map(svc => (
                                <AccessibleButton
                                    ...
                                    onClick={() => {
                                        ...
                                        setStep(2);
                                        speakText({ text: `Please scan your property documents for ${svc.label}.`, language: getLanguageName() });
                                    }}
                ...
                {step === 2 && (
                    <div className="animate-in slide-in-from-bottom-8 duration-500 max-w-3xl mx-auto text-center mt-12">
                        <div className="bg-indigo-100 p-12 rounded-[3.5rem] shadow-xl border border-indigo-200">
                            <h2 className="text-4xl font-black text-indigo-900 mb-6 tracking-tighter">Document Scan Required</h2>
                            ...
                            <div className="bg-white rounded-2xl p-10 mb-8 border-4 border-dashed border-indigo-300 flex flex-col items-center justify-center cursor-pointer hover:bg-indigo-50 transition">
                                ...
                                <p className="text-xl text-indigo-700 font-bold mb-2">Tap to Scan Property Deed</p>
                                <p className="text-xs text-indigo-600 font-bold uppercase tracking-widest">or Building Guidelines</p>
                            </div>
                ...
                {step === 3 && (
                    <div className="animate-in zoom-in-95 duration-700 pt-20 max-w-lg mx-auto text-center">
                        ...
                        <h3 className="text-4xl font-black text-slate-800 mb-4 tracking-tighter">Request Submitted!</h3>
                        <p className="text-xl text-slate-500 font-medium mb-12">
                            Your Property request for '{service}' has been routed to the Town Planning Authority.
                        </p>
                        <AccessibleButton
                            label="Return Home"
