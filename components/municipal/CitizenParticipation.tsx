...
const CIVIC_ACTIONS = [
    { id: 'ward', label: 'Ward Meeting Calendar', icon: Calendar },
    { id: 'suggest', label: 'Submit Suggestion', icon: MessageSquare },
    { id: 'survey', label: 'Local Survey Participation', icon: CheckSquare },
    { id: 'budget', label: 'Budget Transparency', icon: Search },
    { id: 'track', label: 'Track Project Progress', icon: Activity },
    { id: 'rti', label: 'RTI Request Submission', icon: FileSignature }
];
        ...
        <div className={`flex flex-col h-full bg-slate-50 w-full p-8 font-sans ${isPrivacyOn ? 'privacy-sensitive' : ''}`}>
            <div className="flex justify-between items-center mb-12">
                ...
                <h2 className="text-4xl font-black text-slate-800 tracking-tight flex items-center gap-3">
                    <Vote className="text-blue-600" size={36} /> Citizen Participation
                </h2>
            </div>
            ...
            <div className="flex-1 max-w-6xl mx-auto w-full">
                            ...
                            {CIVIC_ACTIONS.map(act => (
                                <AccessibleButton
                                    ...
                                    onClick={() => {
                                        ...
                                        speakText({ text: `Opening ${act.label} dashboard.`, language: getLanguageName() });
                                    }}
                ...
                {step === 2 && (
                    <div className="animate-in zoom-in-95 duration-500 max-w-3xl mx-auto mt-12">
                        <div className="bg-white p-12 rounded-[3.5rem] shadow-xl border border-slate-100 text-center">
                            <h2 className="text-4xl font-black text-slate-900 mb-8 tracking-tighter">Your Ward Meetings</h2>
                            ...
                            <div className="bg-blue-50 rounded-[2rem] p-8 border border-blue-100 text-left space-y-4 mb-10">
                                <div className="flex justify-between border-b border-blue-200 pb-4">
                                    <span className="text-blue-700 font-bold uppercase tracking-widest text-sm">Zone 4 Committee</span>
                                    <span className="bg-blue-600 text-white px-4 py-1 rounded-full text-xs font-black uppercase">Upcoming • Tomorrow</span>
                                </div>
                                <div>
                                    <p className="text-2xl font-black text-slate-900 mb-2">Discussing Smart Traffic System Proposal</p>
                                    <p className="text-slate-600 font-medium">Community Hall A • 18:00 IST</p>
                                </div>
                            </div>
                ...
                {step === 3 && (
                    <div className="animate-in slide-in-from-bottom-8 duration-500 max-w-4xl mx-auto mt-12">
                        <h3 className="text-3xl font-black mb-8 text-slate-800">Tracking: Lake Desilting Phase 2</h3>
                        <div className="bg-white rounded-[3rem] p-10 shadow-lg mb-8">
                            <div className="flex items-center gap-6 mb-8 border-b pb-8">
                                ...
                                <div>
                                    <p className="text-xs font-black uppercase tracking-widest text-slate-400 mb-1">Contractor ID XYA-09</p>
                                    <p className="text-3xl font-black text-slate-900">45% Completed</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-center">
                                    ...
                                    <p className="font-bold text-lg">Survey Completed <span className="text-slate-400 text-sm ml-2">March 2026</span></p>
                                </div>
                                <div className="flex gap-4 items-center">
                                    <div className="w-4 h-4 bg-blue-500 rounded-full animate-pulse"></div>
                                    <p className="font-bold text-lg">Heavy Machinery Deployment <span className="text-slate-400 text-sm ml-2">In Progress</span></p>
                                </div>
                                <div className="flex gap-4 items-center opacity-40">
                                    <div className="w-4 h-4 bg-slate-200 rounded-full"></div>
                                    <p className="font-bold text-lg">Pipeline Rerouting <span className="text-slate-400 text-sm ml-2">Pending</span></p>
                                </div>
                            </div>
                        </div>
                        <AccessibleButton
                ...
                {step === 4 && (
                    <div className="animate-in fade-in duration-500 max-w-2xl mx-auto mt-20 text-center">
                        ...
                        <h3 className="text-4xl font-black mb-4">Under Development</h3>
                        <p className="text-slate-500 text-xl font-medium mb-12">The {view} module is currently being finalized for the production rollout.</p>
                        <AccessibleButton
                            label="Back"
                            language={getLanguageName()}
                            onClick={() => setStep(1)}
